def _aws_codeartifact_get_authorization_token_without_python_deps_impl(ctx: AnalysisContext) -> list[Provider]:
...
aws_codeartifact_get_authorization_token_without_python_deps = rule(
    impl = _aws_codeartifact_get_authorization_token_without_python_deps_impl,
    attrs = {
        "domain": attrs.string(),
